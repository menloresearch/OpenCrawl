...
# Run the OpenCrawl demo script from within Docker
# This ensures proper connectivity to the database and Kafka

echo "=== Starting OpenCrawl Demo ==="

# Ensure Docker services are running
if ! docker ps | grep -q opencrawl-postgres; then
...
# Create a Python script to run the demo
cat > demo.py << 'EOF'
#!/usr/bin/env python3
import asyncio
import os
